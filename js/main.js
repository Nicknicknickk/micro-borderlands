/* ==========================================
   MAIN.JS — Entry point v2.0
   ========================================== */

// ── Boot ───────────────────────────────────
updateMenuStats();

// ── Extend maps with new ones ──────────────
extendMaps();

// ── Init first train warning ───────────────
setTimeout(() => { if(typeof trainWarning !== 'undefined') trainWarning = 120; }, 8000);
...
function buildPlayer(charClass) {
  ...
  return {
    x:WORLD_W/2, y:WORLD_H/2, hp:baseMaxHp, maxHp:baseMaxHp,
    lastX:WORLD_W/2, lastY:WORLD_H/2,
    shield:totalMaxShield, maxShield:totalMaxShield, shieldRechargeDelay:0,
